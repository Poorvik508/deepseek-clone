  ...
  return (
    ...
    >
      <div>
        ...
        <button className={clsx("mt-8 flex items-center justify-center cursor-pointer",
          ...
          <div className="absolute w-max -top-12 -right-12 opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none">New chat
        ...
        <div className={clsx("mt-8 text-white/25 text-sm",
          expand?"block":"hidden"
        )}>
      ...
      <div>
        <div className={clsx(
          ...
          expand?"gap-1 text-white/80 text-sm p-2.5 border border-primary rounded-lg hover:bg-white/10 cursor-pointer":"h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg"
        )}>
          <Image className={clsx(expand ? "w-5" : "w-6.5 mx-auto")} src={expand ? assets.phone_icon : assets.phone_icon_dull} alt="" />
          <div className={clsx("absolute -top-60 pb-8 ",
          ...
          <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg ">
            ...
            <div className={clsx("w-3 h-3 absolute bg-black rotate-45",
